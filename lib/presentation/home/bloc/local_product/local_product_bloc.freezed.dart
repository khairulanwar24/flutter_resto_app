...
abstract class $LocalProductEventCopyWith<$Res> {
  factory $LocalProductEventCopyWith(
    LocalProductEvent value,
    $Res Function(LocalProductEvent) then,
...
abstract class _$$GetLocalProductImplCopyWith<$Res> {
  factory _$$GetLocalProductImplCopyWith(
    _$GetLocalProductImpl value,
...
class __$$GetLocalProductImplCopyWithImpl<$Res>
  ...
  __$$GetLocalProductImplCopyWithImpl(
    _$GetLocalProductImpl _value,
    $Res Function(_$GetLocalProductImpl) _then,
  ) : super(_value, _then);
...
abstract class $LocalProductStateCopyWith<$Res> {
  factory $LocalProductStateCopyWith(
    LocalProductState value,
    $Res Function(LocalProductState) then,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<Product> product) : _product = product;
  ...
  @override
  String toString() {
    return 'LocalProductState.loaded(product: $product)';
  }
...
abstract class _Loaded implements LocalProductState {
  const factory _Loaded(final List<Product> product) = _$LoadedImpl;
